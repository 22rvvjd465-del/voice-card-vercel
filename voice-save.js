...
frame.addEventListener('load',()=>{
 ...
 area.innerHTML='<div class="route-save-panel"><div class="route-save-kicker">SAVE</div><div class="route-save-title">ボイスページを保存</div><p class="route-save-copy">写真と声を、動画として手元に残せます。動画が開いたら右下の「…」から共有し、「ビデオを保存」を選んでください。</p><button class="route-save-btn" type="button">ボイスページを動画で保存</button><p class="route-save-status" aria-live="polite"></p></div>';
